...
import {getPhonesByBrand, getPhonesFetch, setCurrentModel} from "../../store/slices/phones.slices";
...
const PhonesByBrand =  (): JSX.Element => {
    ...
    const phones = useAppSelector(state => state.phone.phones).filter( b => b.brand.id===id);
    console.log(phones);
    return (<div>
