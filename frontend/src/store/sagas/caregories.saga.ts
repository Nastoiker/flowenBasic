...
// import {SecondCategoryState} from "../SecondCategory.slice";
//
// export function* workerCategoriesSaga() {
//     console.log(11111);
//     const data:Promise<SecondCategoryState> = yield call(() => fetch( DOMEN.brand.getBrands));
