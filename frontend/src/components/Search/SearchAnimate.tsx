...
const SearchBar = () => {
    ...
    return (
        <div>
            <button onClick={handleSearchClick}><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <motion.div
                ...
                animate={{ opacity: isSearchVisible ? 1 : 0, x: isSearchVisible ? 0 : +50,  width: '100%' }}
