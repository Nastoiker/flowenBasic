const Star = ({ rating }: { rating: number}) => {
    ...
    const starPoints = '12,1 15.09,8.09 23,9.36 17,14.64 18.18,22.55 12,18.18 5.82,22.55 7,14.64 1,9.36 8.91,8.09'; // координаты звезды
    ...
    return (
        <svg width={starWidth} height={starHeight} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <defs>
