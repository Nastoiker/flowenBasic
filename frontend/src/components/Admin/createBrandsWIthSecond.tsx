...
import {ICreateBrandWithSecondCategory, ICreateSecondCategoryWithBrand} from "../../../interfaces/admin.interface";
...
export const CreateBrandsWIthSecond = (): JSX.Element => {
    ...
    const onSubmit = async (formData: ICreateBrandWithSecondCategory) => {
        ...
        console.log(form);
        try {
            const {data} = await axios.post(DOMEN.admin.createBrand, {...form}, {
                headers: {
