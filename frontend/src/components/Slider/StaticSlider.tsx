...
export const StaticSlider = ({
  ...
  return (
    <div>
      ...
      <div
        className={
          "text-white my-5 mx-auto justify-center sm:flex items-center"
        }
      >
        <div
          key={items[0].title}
          className="bg-zinc-800 w-fit p-5 px-16 m-10 rounded-2xl text-center hover:scale-110 transition-all"
        >
