    ...
    return (
        <AlertDialog>
            <AlertDialogTrigger asChild>
                <Button className={"px-0"} variant="ghost">Правовые условия пользования сайтом</Button>
            </AlertDialogTrigger>
            <AlertDialogContent>
                <AlertDialogHeader>
                    <AlertDialogTitle>Правовые условия пользования сайтом</AlertDialogTitle>
                    <AlertDialogDescription>
                        Настоящие Условия использования Сайтов (далее по тексту — «Условия», «настоящие Условия») являются соглашением о порядке использования конечным пользователем (далее по тексту — «Пользователь») интернет-сайтов, расположенных по адресам https://hh.ru, https://talantix.ru, управляемых и администрируемых ООО «Хэдхантер» (ИНН 7718620740, адрес: 129085, г.Москва, ул.Годовикова, д.9, стр.10) (далее по тексту — «Администрация Сайта»/ «Исполнитель») и других сайтов, управляемых Администрацией Сайта или сайтов, являющихся партнерами ООО «Хэдхантер» (далее по тексту — «Сайт»).
